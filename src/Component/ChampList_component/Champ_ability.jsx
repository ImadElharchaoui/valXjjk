...
const Champ_ability = ({characterName , LastName}) => {
  ...
  return (
    <div className='h-[600px] w-[400px]  absolute right-40 z-10'>
        <div className='text-black text-3xl font-kode font-extrabold p-4 bg-white/50'>
            <p>{characterName}</p>
            <p>{LastName}</p>
        </div>

        <div className='flex  mt-4 p-4 justify-around'>
            <div className=' bg-white/50 w-20 h-24 flex flex-col justify-center items-center '>
